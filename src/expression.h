...
class Expression {
	// We try to store expressions as high up the enum as we can, i.e. if
	// possible, we store everything as integers. rational and rational_decimal
	// are the same number, and only differ in ostream representation
	//  rational is displayed in the standard fraction format, rational_decimal is
...
public:
	...
	// If state_ is rational or rational_decimal, switches state_ to the other
	// format.
